...
merged_data = pd.read_csv("/mnt/d/Projects/Abhishek_sir_project/AMR/Results/merged_output_norm.tsv", sep="\t")
...
# Perform K-means clustering with KMeans++
num_clusters = 2
...
plt.legend()
plt.grid(True)
plt.savefig("/mnt/d/Projects/Abhishek_sir_project/AMR/CLUST/Kmean0++.png")
